      ...
      >
        ...
        <div
          className={`
            ...
            transition-all duration-300 transform flex-none
...
const FrequentQuestions = () => {
  const questions = [
    {
      ...
      answer:
        "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam et leo interdum, malesuada metus sed, porttitor tellus. Cras faucibus consequat risus, vitae tincidunt orci ullamcorper mattis. Sed aliquet mi et nisl vestibulum, eu elementum velit ultrices.",
    },
    {
  ...
  return (
    <div className="w-full max-w-6xl mx-auto p-4" id="faq">
